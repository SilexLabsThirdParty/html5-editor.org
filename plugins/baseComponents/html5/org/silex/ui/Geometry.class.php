...
class org_silex_ui_Geometry extends org_silex_ui_UiBase {
	...
	public function returnHTML() {
		$aleaCanvasName = "geomCanvas" . Std::string(Math::round(Math::random() * 10000));
		$res = "<canvas style='vertical-align:top;' id='" . $aleaCanvasName . "' width='" . $this->width . "' height='" . $this->height . "'>";
		$res .= "</canvas>";
